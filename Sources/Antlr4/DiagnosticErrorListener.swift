...
public class DiagnosticErrorListener: BaseErrorListener {
    ...
    internal func getDecisionDescription(_ recognizer: Parser, _ dfa: DFA<ParserATNConfig>) -> String {
    ...
    ///
    internal func getConflictingAlts(_ reportedAlts: BitSet?, _ configs: ATNConfigSet<ParserATNConfig>) -> BitSet {
        return reportedAlts ?? configs.getAltBitSet()
    }
}

private func getTextInInterval(_ recognizer: Parser, _ startIndex: Int, _ stopIndex: Int) -> String {
    do {
